package com.fileupload.selfprotocol.client;

import com.fileupload.selfprotocol.client.handler.TransClientHandler;
import com.fileupload.selfprotocol.client.handler.TransClientHeartBeatHandler;
...
public class TransClient {
    public void bind(int port) {
        ...
        try {
            ...
            ChannelFuture f = b.connect("10.5.0.115", port).sync();
            ...
            while(true){
                if(in.equals("register")){
                    ...
                    File file = new File("F:\\BaiduNetdiskDownload\\Netty.pdf");
